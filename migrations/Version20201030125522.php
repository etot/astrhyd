 ...
 */
final class Version20201030125522 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE agence_nomenclature_id_seq CASCADE');
        ...
        $this->addSql('CREATE SEQUENCE base_stockage_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE direction_regionale_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE finalite_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE mesure_accompagnement_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE mo_suivis_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE mo_travaux_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE modalite_operation_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE protocole_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE type_travaux_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE agence (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE base_stockage (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE direction_regionale (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE finalite (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE mesure_accompagnement (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE mo_suivis (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE mo_travaux (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE modalite_operation (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE protocole (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE type_travaux (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('DROP TABLE agence_nomenclature');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP SEQUENCE base_stockage_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE direction_regionale_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE finalite_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE mesure_accompagnement_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE mo_suivis_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE mo_travaux_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE modalite_operation_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE protocole_id_seq CASCADE');
        $this->addSql('DROP SEQUENCE type_travaux_id_seq CASCADE');
        $this->addSql('CREATE SEQUENCE agence_nomenclature_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE agence_nomenclature (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
